...
public class Campaign
{
    ...
    public static long Add(Campaign post)
    {
        ...
        string sql = "INSERT INTO dbo.campaigns (language_id, name, category_name, image_name, link_url, inactive) "
            + "VALUES (@language_id, @name, @category_name, @image_name, @link_url, @inactive);SELECT SCOPE_IDENTITY();";
    ...
    public static void Update(Campaign post)
    {
        ...
        string sql = "UPDATE dbo.campaigns SET language_id = @language_id, name = @name, category_name = @category_name, "
            + "image_name = @image_name, link_url = @link_url, inactive = @inactive WHERE id = @id;";
