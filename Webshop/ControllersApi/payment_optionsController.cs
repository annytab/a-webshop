...
{
    /// <summary>
    /// This class controls the api for payment options
    /// </summary>
    public class payment_optionsController : ApiController
    {
        #region Insert methods

        // Add a payment option
        // POST api/payment_options/add?languageId=1
        ...
        // PUT api/payment_options/update?languageId=5
        ...
        // PUT api/payment_options/translate?languageId=1
        [ApiAuthorize(Roles = "API_FULL_TRUST,API_MEDIUM_TRUST")]
        [HttpPut]
        ...
        // GET api/payment_options/get_count_by_search?keywords=one%20two&languageId=1
        ...
        // GET api/payment_options/get_by_id/5?languageId=1
        [ApiAuthorize(Roles = "API_FULL_TRUST,API_MEDIUM_TRUST,API_MINIMAL_TRUST")]
        [HttpGet]
        ...
        // GET api/payment_options/get_all?languageId=1
        [ApiAuthorize(Roles = "API_FULL_TRUST,API_MEDIUM_TRUST,API_MINIMAL_TRUST")]
        [HttpGet]
        public List<PaymentOption> get_all(Int32 languageId = 0, string sortField = "", string sortOrder = "")
        {
            // Create the list to return
            List<PaymentOption> posts = PaymentOption.GetAll(languageId, sortField, sortOrder);
        ...
        // GET api/payment_options/get_all_active?languageId=1
        [ApiAuthorize(Roles = "API_FULL_TRUST,API_MEDIUM_TRUST,API_MINIMAL_TRUST")]
        [HttpGet]
        ...
        // GET api/payment_options/get_by_search?keywords=one%20two&languageId=1&pageSize=10&pageNumber=2&sortField=id&sortOrder=ASC
        [ApiAuthorize(Roles = "API_FULL_TRUST,API_MEDIUM_TRUST,API_MINIMAL_TRUST")]
        [HttpGet]
        public List<PaymentOption> get_by_search(string keywords = "", Int32 languageId = 0, Int32 pageSize = 0, Int32 pageNumber = 0,
            string sortField = "", string sortOrder = "")
        {
            ...
            // Create the list to return
            List<PaymentOption> posts = PaymentOption.GetBySearch(wordArray, languageId, pageSize, pageNumber, sortField, sortOrder);
        ...
        // DELETE api/payment_options/delete/1?languageId=0
        [ApiAuthorize(Roles = "API_FULL_TRUST")]
        [HttpDelete]
