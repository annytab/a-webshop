...
{
    /// <summary>
    /// This class controls the api for option types
    /// </summary>
    public class option_typesController : ApiController
    {
        #region Insert methods

        // Add a option type
        // POST api/option_types/add?languageId=5
        ...
        // PUT api/option_types/update?languageId=5
        ...
        // PUT api/option_types/translate?languageId=5
        [ApiAuthorize(Roles = "API_FULL_TRUST,API_MEDIUM_TRUST")]
        [HttpPut]
        ...
        // GET api/option_types/get_count_by_search?keywords=one%20two&languageId=1
        ...
        public Int32 get_count_by_search(string keywords = "", Int32 languageId = 0)
        {
            ...
            // Get the count
            Int32 count = OptionType.GetCountBySearch(wordArray, languageId);
        ...
        // Get a option type by id
        // GET api/option_types/get_by_id/5?languageId=1
        [ApiAuthorize(Roles = "API_FULL_TRUST,API_MEDIUM_TRUST,API_MINIMAL_TRUST")]
        [HttpGet]
        ...
        // GET api/option_types/get_all?languageId=1
        [ApiAuthorize(Roles = "API_FULL_TRUST,API_MEDIUM_TRUST,API_MINIMAL_TRUST")]
        [HttpGet]
        ...
        // GET api/option_types/get_by_search?keywords=one%20two&languageId=1&pageSize=10&pageNumber=2&sortField=id&sortOrder=ASC
        [ApiAuthorize(Roles = "API_FULL_TRUST,API_MEDIUM_TRUST,API_MINIMAL_TRUST")]
        [HttpGet]
        public List<OptionType> get_by_search(string keywords = "", Int32 languageId = 0, Int32 pageSize = 0, Int32 pageNumber = 0,
            string sortField = "", string sortOrder = "")
        {
            ...
            // Create the list to return
            List<OptionType> posts = OptionType.GetBySearch(wordArray, languageId, pageSize, pageNumber, sortField, sortOrder);
        ...
        // Delete a option type
        // DELETE api/option_types/delete/5?languageId=0
        [ApiAuthorize(Roles = "API_FULL_TRUST")]
        [HttpDelete]
